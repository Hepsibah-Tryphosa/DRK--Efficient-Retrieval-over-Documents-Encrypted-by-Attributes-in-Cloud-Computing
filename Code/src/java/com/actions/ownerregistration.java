 ...
 * @author Ramu Maloth
 */
@WebServlet(name = "ownerregistration", urlPatterns = {"/ownerregistration"})
public class ownerregistration extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      String status="waiting";
        ...
        String query = "insert into dataowner(username,password,email,mobile,branch,department,subdept,jobrole,status) values(?,?,?,?,?,?,?,?,?)";
