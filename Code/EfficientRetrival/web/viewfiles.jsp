        ...
        <section class="breadcrumb_area blog_banner_two">
            ...
            <div class="container">
                <div class="page-cover text-center">
                    <h5 class="page-cover-tittle f_48">View Files</h5>
           <div class="row">
                            ...
                            <tr>
                                <%
                                    ...
                                    try {
                                        ...
                                        rs = st.executeQuery("select * from datafiles where username='"+username+"' ");
                                        while(rs.next())
