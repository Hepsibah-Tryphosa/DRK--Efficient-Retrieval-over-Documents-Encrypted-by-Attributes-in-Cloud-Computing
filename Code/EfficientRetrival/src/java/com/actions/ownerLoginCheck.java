...
public class ownerLoginCheck extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
          ...
          ResultSet rt=st.executeQuery("select * from dataowner where username='"+username+"'");
          if(rt.next()){
              String p=rt.getString("password");
              String branch=rt.getString("branch");
              String department=rt.getString("department");
              String subdept=rt.getString("subdept");
              String jobrole=rt.getString("jobrole");
                      ...
                      user.setAttribute("id", id);
                       user.setAttribute("branch", branch);
                        user.setAttribute("department", department);
                         user.setAttribute("subdept", subdept);
                          user.setAttribute("jobrole", jobrole);
